...
<head>
  ...
  <title>Tiket Kereta | <?php echo $__env->yieldContent('title'); ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Tiket</b> Kereta</span>
    </a>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <button type="submit" href="#" class="btn btn-default btn-flat">Log out</a>
                  </form>
                </div>
              </li>
            </ul>
...
<?php /**PATH C:\xampp\htdocs\pbd_uas\resources\views/layout/v_template.blade.php ENDPATH**/ ?>